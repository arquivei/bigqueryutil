...
- Provide a lib for transform messages into documents;
- A standard single way of doing things;
- Facilitate the developing Workers;

### Does it follow the contributor covenant

This repository has a [code of conduct](CODEOFCONDUCT.md), we will
